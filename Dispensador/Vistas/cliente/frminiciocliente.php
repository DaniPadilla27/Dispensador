...
url('fondo3.jpg'); background-size: cover;">
  ...
  <nav>
    ...
    <li><a href="http://localhost/Dispensador/?C=Controladorcliente&M=iniciocliente">Inicio</a></li>
      <li><a href="http://localhost/Dispensador/?C=Controladorcliente&M=productoscliente">Productos</a></li>
  ...
  <div><p></p></div>
    <img src="/" alt="">
  <div class="box">
  <H2>BIENVENIDO A PLANETA MASCOTAS</H2>
  <hr>
  <p></p>
  <p> En esta pagina web donde pretendemos vender un dispensador de alimento para mascotas en el cual el cliente podrá visualizar y realizar compras y el administrador dará de alta a los empleados y productos. </p>

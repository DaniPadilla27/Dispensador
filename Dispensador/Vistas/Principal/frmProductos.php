...
if (!empty($productos)) {
  ...
  foreach ($productos as $producto) {
    $imgFinal='data:image/jpeg;base64,'.base64_encode($producto['imagen']);    
      ...
      <div class="items">
          ...
          <a href="http://localhost/Dispensador/?C=controladoraltaproductos&M=MostrarDetalleProducto&id=<?= $producto['Idproducto'] ?>"><img src="<?php echo $imgFinal; ?>"></a>
          <div class="info">
              ...
              <form action="http://localhost/Dispensador/?C=controladorprincipal&M=Productos" method="POST">
  ...
  <script>
      function showAlert() {
        alert("Para realizar una compra, primero debe registrarse.");
      }
    </script>
  <?php
} else {
